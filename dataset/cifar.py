...
def get_svnh(args, root):get_svnh
...
#            a, b = self.target_transform(target)
#            target = [index, a, b]
#            index += 1
...
class SVNHSSL(datasets.CIFAR10):
    def __init__(self, root, indexs, train=True,
                 transform=None, target_transform=None,
                 download=False):
        super().__init__(root, train=train,
